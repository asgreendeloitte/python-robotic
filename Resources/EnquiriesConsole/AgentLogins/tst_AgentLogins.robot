...
${login-url}        https://nhs--dhqa.lightning.force.com/lightning/page/home
${logout-url}       https://nhs--dhqa.my.salesforce.com/secur/logout.jsp
${home-url}         https://nhs--dhqa.lightning.force.com/lightning/page/home

${cases-url}        https://nhs--dhqa.my.salesforce.com/lightning/o/Case/list?filterName=Recent




# Test logins
${test-dhqa-username}             hhaneef@deloitte.co.uk.dhqa
