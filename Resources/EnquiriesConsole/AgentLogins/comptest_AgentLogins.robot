...
${login-url}        https://nhs--comptest.my.salesforce.com/lightning/page/home
${logout-url}       https://nhs--comptest.my.salesforce.com/secur/logout.jsp
#${cases-url}        https://nhs--comptest.my.salesforce.com/lightning/o/Case/home

${cases-url}        https://nhs--comptest.my.salesforce.com/lightning/o/Case/list?filterName=Recent
${reports-url}      https://nhs--comptest.sandbox.lightning.force.com/lightning/o/Report/home?queryScope=mru
${accounts-url}     https://nhs--comptest.sandbox.lightning.force.com/lightning/o/Account/list?filterName=Recent
${home-url}         https://nhs--comptest.sandbox.lightning.force.com/lightning/page/home

#/lightning/o/Case/list?filterName=Recent
# Test logins
...
${parliamentary-rights-team-member}            automation.parli.agent@deloitte.co.uk.comptest
${public-complaints-team-member}               automation.public.complaints.agent@deloitte.co.uk.comptest
${information-rights-team-member}              automation.info.rights.agent@deloitte.co.uk.comptest
${information-rights-super-user}               automation.information.rights.superuser@deloitte.co.uk.comptest
${public-enq-team-member}                      automation.pe.agent@deloitte.co.uk.comptet
${public-enq-super-user}                       automation.pe.superuser@deloitte.co.uk.comptest
