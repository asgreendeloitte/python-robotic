...
${login-url}        https://nhs--uat.sandbox.my.salesforce.com/
...
${cases-url}        https://nhs--uat.sandbox.lightning.force.com/lightning/o/Case/list?filterName=Recent
${home-url}         https://nhs--uat.sandbox.lightning.force.com/lightning/page/home
${accounts-url}     https://nhs--uat.sandbox.lightning.force.com/lightning/o/Account/home
${campaigns-url}    https://nhs--uat.sandbox.lightning.force.com/lightning/o/Campaign/list?filterName=Recent
${reports-url}    https://nhs--uat.sandbox.lightning.force.com/lightning/o/Report/home?queryScope=mru
...
${logout-url}       https://nhs--uat.sandbox.lightning.force.com//secur/logout.jsp
# Test logins
...
${password}         10Piik89T&T#1
${password2}         10Piik89T&T1
