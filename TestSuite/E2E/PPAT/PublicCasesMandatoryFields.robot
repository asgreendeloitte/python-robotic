...
#Information Rights - Mandatory Fields
#    [Tags]  TTCS20-5773-01-04-06
#
...
#    Click Save
#    Sleep   5s
#    Page Should Contain             Please update the mandatory fields on the case before saving. The mandatory fields are Case Type, Account Name, Account Email, Contact Name, Web Email, ExCo Group, Category & Subcategory
#    Page Should Contain             Please update the mandatory fields on the case before saving. The mandatory fields are Outcome, Disclosure Position, Exemptions Applied & Information Published
#    Click Cancel
#    Sleep  3s
#    Click Edit
#    Sleep  3s
