...
Public Complaints Deadlines updated
    ...
    page should contain element               //div[contains(text(),'Time Remaining (Days):')]
    ...
    ${t-r-date}=     Get Text  ${time-rem-days}
    #${t-r-date}=  Get Text   ${time-rem-days}
    Should Contain Any  ${t-r-date}    20
    Sleep  3s
    Click Element    //body/div[4]/div[1]/section[1]/div[1]/div[1]/div[2]/div[2]/section[1]/div[1]/div[1]/section[1]/div[1]/div[2]/div[1]/div[1]/div[1]/one-record-home-flexipage2[1]/forcegenerated-adg-rollup_component___force-generated__flexipage_-record-page___-p-p-a-t_-public_-lightning_-record_-page___-case___-v-i-e-w[1]/forcegenerated-flexipage_ppat_public_lightning_record_page_case__view_js[1]/record_flexipage-desktop-record-page-decorator[1]/div[1]/records-record-layout-event-broker[1]/slot[1]/slot[1]/flexipage-record-home-template-desktop2[1]/div[1]/div[2]/div[2]/slot[1]/flexipage-component2[1]/slot[1]/lst-related-list-single-container[1]/laf-progressive-container[1]/slot[1]/lst-related-list-single-aura-wrapper[1]/div[1]/div[1]/article[1]/div[2]/div[1]/div[1]/div[1]/div[1]/ul[1]/li[1]/article[1]/div[1]/div[1]/div[1]/a[1]/span[1]/span[1]
    #(//*[contains(text(),'Show more actions')])[2]
    Sleep  3s
    Click Element    (//a[@title="Edit"])
    page should contain         Completion Date
    Click Element       (//span[contains(text(),'Cancel')])[2]
#    Click Edit
...
#    Scroll Element Into View    //input[@placeholder='Search Live Issues...']
    ...
    #${trgt-time}=      Get Text   ${ext-time-rem}
    #Log to Console  ${trgt-time}
    #Should Not Contain Any    ${trgt-time}     0.00
    ...
    page should not contain element         (//*[contains(text(),'0.00')])[2]
    ...
    Sleep  5s
#    ${trgt-time}=      Get Text   ${ext-time-rem}
#    Should Contain Any    ${trgt-time}     0.00
    page should contain element         (//*[contains(text(),'0.00')])[2]
    Sleep  3s
    page should contain element   ${violation_milestone_check}
    Click element     (//*[@name="Case.New_Contribution"])[1]
    Input Text     (//*[@class="slds-combobox__input slds-input"])[1]    token
    Click Element   (//*[contains(text(),'Save')])[7]
    Sleep  5s
    Click Element   (//a[contains(text(),'token')])[1]
