...
Public Enquiries Contribution Activity
    [Tags]  TTCS20-5801-01  TTCS20-5848
...
Information Rights Contribution Activity
    [Tags]  TTCS20-5801-02  TTCS20-5848
    Go To Salesforce login
...
Public Complaints Contribution Activity
    [Tags]  TTCS20-5801-03    TTCS20-5848
    Go To Salesforce login
...
Parliamentary Contribution Activity
    [Tags]  TTCS20-5801-04
    Go To Salesforce login
    ...
    Page Should Contain       All types
    Page Should Contain       Upcoming & Overdue
    Page Should Contain Element    (//span[@class='view-all-label'])[1]
    Click Element                  (//span[@class='view-all-label'])[1]
    Sleep  3s
    Page Should Contain       Subject
    Page Should Contain       Contact Name
    Page Should Contain       Due Date
...
Parliamentary Contribution Layout
    [Tags]  TTCS20-5801-08
    Go To Salesforce login
    Login as PPAT Parliamentary rights team member
    Reset View (if applicable)
...
Contribuiton Time Violation
    ...
    Click Element   ${app_launcher}
        ...
        Sleep  3s
        Page Should Contain Element    (//img[@alt='True'])[1]
