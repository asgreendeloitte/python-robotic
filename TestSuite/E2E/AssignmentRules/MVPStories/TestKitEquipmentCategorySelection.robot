...
*** Test Cases ***
Test Agent adds TestKit/Equipment Category selection
    [Tags]  TTCS20-1994
    ...
    Select Dropdown Option      Test/Kit Equipment
    Click Drop Down By Name     Subcategory
   Select Dropdown Option      Test kit(s) not arrived

    Click Save
    Wait Until Page Has Saved


Trace Agent adds TestKit/Equipment Category selection
    [Tags]  TTCS20-1994
