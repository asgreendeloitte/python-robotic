...
Profanity Exclusions - Sanisation
    [Tags]  TTCS20-3977
    ...
    Input your First Name   Jarvis
    Input your Last Name    Cocker
    Input your mobile phone number (Optional)   077556644553
    Click Continue on the page

    Page should contain     What is your email address?
    Enter email address     jcocker@gmail.com
    Confirm email address   jcocker@gmail.com
    Click Continue on the page
...
Profanity Exclusions - Accepted profanities
    [Tags]  TTCS20-3977
    ...
    Page should contain     What are your contact details?
    Input your First Name   Jarvis
    Input your Last Name    Muff
    Input your mobile phone number (Optional)   077556644553
    Click Continue on the page

    Page should contain     What is your email address?
    Enter email address     jcunt@gmail.com
    Confirm email address   jcunt@gmail.com
    Click Continue on the page
...
Profanity Exclusions - Email address
    [Tags]  TTCS20-3977
    ...
    Page should contain     What is your email address?
    Enter email address     fuckmail@gmail.com
    Confirm email address   fuckmail@gmail.com
    Click Continue on the page
...
Profanity Exclusions - First Name, Last Name and Full Name fields
    [Tags]  TTCS20-3977
    ...
    Page should contain     What are your contact details?
    Input your First Name   Fuck
    Input your Last Name    Bastard
    Input your mobile phone number (Optional)   077556644553
    Click Continue on the page

    Page should contain     What is your email address?
    Enter email address     fuckbastard@gmail.com
    Confirm email address   fuckbastard@gmail.com
    Click Continue on the page
